...
const DEFAULT_FOOTER = {
  ...
  section4Title: 'Legal',
  copyrightText: '© 2024 TestWebsite. All rights reserved.',
  madeWithText: 'with passion',
  socialText: 'Follow us:',
  social1Href: 'https://twitter.com',
  social2Href: 'https://linkedin.com',
  social3Href: '#',
  social4Href: '#',
  social5Href: '#',
  // Product Links
  ...
  linkBlogHref: '#hero',
  linkCareers: 'Careers',
  linkCareersHref: '#hero',
  linkPress: 'Press',
  linkPressHref: '#hero',
  linkPartners: 'Partners',
  linkPartnersHref: '#hero',
  linkContact: 'Contact',
  ...
  linkCookiesHref: '#hero',
  linkGdpr: 'GDPR',
  linkGdprHref: '#hero',
  linkSecurity: 'Security',
  linkSecurityHref: '#hero',
  linkCompliance: 'Compliance',
  linkComplianceHref: '#hero',
  // Bottom Links
  linkSitemap: 'Sitemap',
  linkSitemapHref: '#hero',
  linkAccessibility: 'Accessibility',
  linkAccessibilityHref: '#hero',
  linkCookieSettings: 'Cookie Settings',
  linkCookieSettingsHref: '#hero',
  linkSupport: 'Support',
  linkSupportHref: '#hero',
} as const;
